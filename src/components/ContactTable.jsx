...
const ContactTable = () => {
  ...
  return (
    <>
          ...
          <TableBody>
            {contacts.map((row) => (
              ...
              >
                ...
                <TableCell sx={{ color: "#7B8594" }}>
                  {row.createdAt.slice(0, row.createdAt.indexOf("T"))}
                </TableCell>
                <TableCell
                  sx={{
      ...
      >
        {openForm === "edit" && (
          <EditContact onClose={handleFormClose} data={selectedContact} />
        )}
        {openForm === "delete" && (
          <DeleteContact onClose={handleFormClose} id={deletedContact} />
        )}
      </Dialog>
    </>
  );
